// From https://codepen.io/adrian-ortega/pen/YjqrMw
...
const state = {
  ...
  particles: [],
  stats: null,
  colors: ["#CF92AA", "#4D83AF", "#C0B622", "#447988", "#51ABA5", "#505256"],
};
...
class Particle {
  constructor(id = 0) {
    ...
    this.strokeWidth = Math.random() * (Math.random() > 0.5 ? 2.5 : 5.5);
    ...
    switch (this.type) {
      ...
      case "line":
        ...
        this.length = this.randomFromArray([5, 10, 15, 20]);
